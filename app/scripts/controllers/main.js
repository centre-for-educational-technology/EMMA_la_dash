...
/**
 * @ngdoc function
 * @name emmaDashboardApp.controller:MainCtrl
 * @description
 * # MainCtrl
 * Controller of the emmaDashboardApp
 */
angular.module('emmaDashboardApp')
  .controller('MainCtrl', function ($scope, $window, $location, apiService) {
    ...
    if ( locationSearch.course_id ) {
      courseId = locationSearch.course_id;
    } else {
